...
export default async function configureMediaKeysFor(mediaElement: HTMLMediaElement, selectedSystem: string, config: MediaKeyConfigurationType[typeof selectedSystem]) {
